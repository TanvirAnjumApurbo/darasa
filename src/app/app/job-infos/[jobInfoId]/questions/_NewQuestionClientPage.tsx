...
// Removed zod import since questionId now comes via response header
...
export function NewQuestionClientPage({
  ...
  const {
    ...
    // @ts-expect-error onResponse may not yet be in the published type definition
  ...
  // questionId now comes from the response header set by the server route.
